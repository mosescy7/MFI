-- ============================================================================
-- PNR15: NON-EARNING ASSETS
-- ============================================================================
-- Purpose:   Total non-earning assets per LE_Book per month.
--            Ratio = Non-Earning Assets / Total Assets * 100 (Max 10%)
--
-- Output:    One row per LE_Book / Year_Month with non-earning assets amount.
