-- ============================================================================
-- PNR14: LAND AND BUILDINGS TO TOTAL ASSETS
-- ============================================================================
-- Purpose:   Total land and buildings per LE_Book per month.
--            Ratio = Land & Buildings / Total Assets * 100 (Max 5%)
--
-- Output:    One row per LE_Book / Year_Month with land & buildings amount.
...
SELECT
    ...
    SUM(Balance_Value) AS Land_And_Buildings
FROM (
    SELECT
        fhh.Year,
        fhh.LE_Book,
