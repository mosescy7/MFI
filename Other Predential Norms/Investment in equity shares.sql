-- ============================================================================
-- PNR18: INVESTMENT IN EQUITY SHARES
-- ============================================================================
-- Purpose:   Total investment in equity shares per LE_Book per month.
--            Ratio = Equity Shares / Core Capital * 100 (Max 25%)
--            For SACCOs: use total equity instead of core capital.
--
-- Output:    One row per LE_Book / Year_Month with equity shares amount.
...
WHERE
    Year || LPAD(TO_CHAR(Month_Number), 2, '0') >= TO_CHAR(ADD_MONTHS(SYSDATE, -13), 'YYYYMM')
