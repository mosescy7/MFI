...
# DATA LOADING
# ============================================================
le_books   <- paste0(4, sprintf("%02d", 1:20))
yr_months  <- format(
...
inst_names <- c(
  "Urwego Bank","Equity Bank","Vision Finance","CLECAM","Inkingi MFI",
  "Goshen Finance","UNGUKA Bank","COPEDU","Duterimbere MFI","Réseau Imbaraga",
  "FINA Bank MFI","Prime MFI","MUGANGA SACCO","Umurenge SACCO A","Umurenge SACCO B",
  "COOCEC SACCO","TERIMBERE SACCO","INZORA SACCO","UBUMWE SACCO","AGASEKE SACCO"
)
...
if (!is.null(con)) {
  ...
  df_lebook <- data.frame(
    ...
    category_type        = sample(categories, length(le_books), replace = TRUE),
    leb_status           = "A",
    stringsAsFactors     = FALSE
  )
